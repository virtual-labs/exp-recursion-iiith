...
Given a weighing pan, n weights and a destination weight D, print gYESh or gNOh depending whether you can weight D using other weights given.  
...
As the output, print gYESh if it is possible to weight D, otherwise gNOh.  
